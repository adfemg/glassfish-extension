...
/**
 * Controller for action org.adfemg.gfextension.glassfishstart.
 */
public final class GlassFishStartController implements Controller {
    ...
    /**
     * Handles the user interaction with this action. In this case it calls the Glassfish start command
     * @param action whose command is to be executed.
     * @param context the current context
    ...
    public boolean handleEvent(IdeAction action, Context context) {
        ...
        Process p;
        try {
            p = Runtime.getRuntime().exec(tc.getOSCommand() + " " + tc.getGlassfishStart());
